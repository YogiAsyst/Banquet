...
import com.banquet.acs_banquet.service.CustomerService;
 ...
 * @see Customer
 */
@RestController("acs_banquet.CustomerController")
@Api(value = "CustomerController", description = "Exposes APIs to work with Customer resource.")
@RequestMapping("/acs_banquet/Customer")
public class CustomerController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerController.class);

    @Autowired
	@Qualifier("acs_banquet.CustomerService")
