...
import com.banquet.acs_banquet.service.CartService;
 ...
 * @see Cart
 */
@RestController("acs_banquet.CartController")
@Api(value = "CartController", description = "Exposes APIs to work with Cart resource.")
@RequestMapping("/acs_banquet/Cart")
public class CartController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CartController.class);

    @Autowired
	@Qualifier("acs_banquet.CartService")
