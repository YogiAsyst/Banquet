 ...
 * @see OrderItem
 */
@Service("acs_banquet.OrderItemService")
@Validated
public class OrderItemServiceImpl implements OrderItemService {
    ...
    @Autowired
    @Qualifier("acs_banquet.OrderItemDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service acs_banquet for table OrderItem to {} format", exportType);
