...
public interface Acs_banquetQueryExecutorService {
    ...
    Page<GetPackagePictResponse> executeGet_package_pict(List<Integer> productId, Pageable pageable);

    InputStream getPictContentForGet_package_pict(String pname, Integer prating, List<Integer> productId) throws EntityNotFoundException;

    Downloadable exportGet_package_pict(ExportType exportType, List<Integer> productId, Pageable pageable);

    Page<GetCat3ProductResponse> executeGet_cat_3_product(Pageable pageable);

    InputStream getPpictureContentForGet_cat_3_product(Integer id, String pname, String pdescription, Integer prating, String catName) throws EntityNotFoundException;
    ...
    InputStream getPpictureContentForGet_cat_1_product(Integer id, String pname, String pdescription, Integer prating, String catName) throws EntityNotFoundException;
    ...
    InputStream getPpictureContentForGet_cat_4_product(Integer id, String pname, String pdescription, Integer prating, String catName) throws EntityNotFoundException;
    ...
    InputStream getPpictureContentForGet_cat_2_product(Integer id, String pname, String pdescription, Integer prating, String catName) throws EntityNotFoundException;
