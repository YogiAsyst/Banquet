...
import com.banquet.acs_banquet1.service.CustomerService;
 ...
 * @see Customer
 */
@RestController("acs_banquet1.CustomerController")
@Api(value = "CustomerController", description = "Exposes APIs to work with Customer resource.")
@RequestMapping("/acs_banquet1/Customer")
public class CustomerController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerController.class);

    @Autowired
	@Qualifier("acs_banquet1.CustomerService")
    ...
    public Page<Order> findAssociated_orders(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return customerService.findAssociated_orders(id, pageable);
    }
