...
import com.banquet.acs_banquet1.service.UserService;
 ...
 * @see User
 */
@RestController("acs_banquet1.UserController")
@Api(value = "UserController", description = "Exposes APIs to work with User resource.")
@RequestMapping("/acs_banquet1/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

    @Autowired
	@Qualifier("acs_banquet1.UserService")
    ...
    public User editUser(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        User newUser = WMMultipartUtils.toObject(multipartHttpServletRequest, User.class, "acs_banquet1");
        newUser.setId(id);
