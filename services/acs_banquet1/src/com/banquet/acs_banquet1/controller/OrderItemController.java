...
import com.banquet.acs_banquet1.service.OrderItemService;
...
public class OrderItemController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public OrderItem getOrderItem(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public OrderItem editOrderItem(@PathVariable("id") Integer id, @RequestBody OrderItem orderItem) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteOrderItem(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<OrderItem> searchOrderItemsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering OrderItems list");
	...
	@ApiOperation(value = "Returns the total count of OrderItem instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
