...
import com.banquet.acs_banquet1.service.CartService;
 ...
 * @see Cart
 */
@RestController("acs_banquet1.CartController")
@Api(value = "CartController", description = "Exposes APIs to work with Cart resource.")
@RequestMapping("/acs_banquet1/Cart")
public class CartController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CartController.class);

    @Autowired
	@Qualifier("acs_banquet1.CartService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Cart getCart(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Cart editCart(@PathVariable("id") Integer id, @RequestBody Cart cart) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteCart(@PathVariable("id") Integer id) throws EntityNotFoundException {
    ...
    public Page<Cart> searchCartsByQueryFilters( Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Carts list");
	...
	@ApiOperation(value = "Returns the total count of Cart instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
