...
Application.$controller("dialog_dessertController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("dialog_appetizerController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("dialog_main_courseController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("dialog_allController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("preorderDialogController", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
...
Application.$controller("PreOrderLiveForm1Controller", ["$scope",
	function($scope) {
		"use strict";
		$scope.ctrlScope = $scope;
	}
